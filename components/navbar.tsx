...
export default function Navbar() {
  ...
  return (
    <nav
      className="bg-primary fixed top-0 left-0 w-full shadow-md z-50 p-4 md:px-8 flex justify-between items-center"
      ref={navRef}
    >
      {/* Logo & Brand */}
      <div className="flex items-center space-x-4 relative z-10">
        <img
          ...
          className="h-10"
        />
        <span className="text-2xl font-bold text-white">Intervyou.ai</span>
      </div>
      ...
      <ul className="hidden xl:flex items-center space-x-6 text-white relative z-10">
        <li>
          <CustomDropdown
            trigger={
              <button className="hover:text-black hover:bg-secondary py-2 px-6 rounded-full flex items-center">
                Products{" "}
                <ChevronDown
        ...
        <li>
          <a
            ...
            className="hover:text-black hover:bg-secondary py-2 px-6 rounded-full"
          >
            Features
          </a>
        </li>
        ...
        <li>
          {session ? (
            <button
              ...
              className="text-white border border-secondary hover:text-black hover:bg-secondary py-2 px-6 rounded-full"
            >
              Dashboard
            </button>
          ) : (
