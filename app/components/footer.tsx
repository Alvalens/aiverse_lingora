...
const Footer = () => {
  return (
    <footer className="w-full bg-primary text-color-text py-16 px-4 md:px-8 lg:px-32">
      <div className="flex flex-col lg:flex-row justify-between gap-10">
        {/* Left Section */}
        <div className="w-full lg:w-1/3">
          <div className="flex items-center gap-2">
            <img src="landing-page/logo.svg" alt="Logo" className="w-8 h-8" />
            <h2 className="text-xl font-semibold">Lingora</h2>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center mt-2 border border-gray-600 rounded-lg overflow-hidden">
              <input
                ...
                className="bg-transparent text-color-text px-4 py-2 outline-none w-full"
              />
              <button className="bg-tertiary p-3">
                <svg
        ...
        <div className="w-full lg:w-1/3">
          ...
          <ul className="mt-4 space-y-3">
            <li className="flex items-center gap-3 text-gray-400 hover:text-tertiary transition-colors">
              <MapPin size={18} />
